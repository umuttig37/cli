...
function showModal(restaurant) {
  ...
  addressParagraph.textContent = `Address: ${restaurant.address}, ${restaurant.postalCode} ${restaurant.city}`;

  const phoneParagraph = document.createElement('p');
  phoneParagraph.textContent = `Phone: ${restaurant.phone}`;

  const companyParagraph = document.createElement('p');
  companyParagraph.textContent = `Company: ${restaurant.company}`;

  dialog.appendChild(nameHeader);
  dialog.appendChild(addressParagraph);
  dialog.appendChild(phoneParagraph);
  dialog.appendChild(companyParagraph);
