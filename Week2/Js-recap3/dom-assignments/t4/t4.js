...
function sortRestaurantsByDistance(currentLat, currentLong) {
  return restaurants.sort((a, b) => {
    let distA = calculateDistance(currentLat, currentLong, a.location.coordinates[1], a.location.coordinates[0]);
    let distB = calculateDistance(currentLat, currentLong, b.location.coordinates[1], b.location.coordinates[0]);
    return distA - distB;
  });
}
...
function showRestaurantsNearMe() {
  ...
  function success(position) {
    ...
    const sortedRestaurants = sortRestaurantsByDistance(latitude, longitude);
